# RailsAdmin config file. Generated on December 22, 2012 15:59
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Oladium', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Game', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Game', 'User']
  ...
  #     configure :net_id, :string 
  #     configure :type, :string 
  #     configure :slug, :string 
  #     configure :title, :string 
  #     configure :description, :text 
  #     configure :driving, :string 
  ...
  #     list do
  #       # filters [:id, :name]  # Array of field names which filters should be shown by default in the table header
  #       # items_per_page 100    # OverrideS default_items_per_page
  #       # sort_by :id           # Sort column (default is primary key)
  #       # sort_reverse true     # Sort direction (default is true for primary key, last created first)
  #     end
  #     show do; end
